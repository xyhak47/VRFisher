Shader "Underwater/Terrain"
{
	...
	CGINCLUDE
		#pragma surface surf CustomLambert noambient nofog vertex:SplatmapVert finalcolor:myfinal exclude_path:prepass exclude_path:deferred
	...
	Dependency "AddPassShader" = "Hidden/Underwater/Terrain-AddPass"
	Dependency "BaseMapShader" = "Underwater/Mobile"
